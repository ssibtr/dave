...
var GreetingMessage = AbstractAction.extend({
    ...
    welcome_message: function() {
        ...
        var lines_count = this.attendance.attendance_lines.length;
        ...
        if (lines_count <= 1) {
            ...
            this.$('.o_hr_attendance_message_message').append(_t("You have successfully switched jobs."));
        }
    },
    ...
    farewell_message: function() {
        ...
        if (now.hours() < 12) {
            this.$('.o_hr_attendance_message_message').append(_t("You have been Checked Out. Have a good day!"));
        } else if (now.hours() < 14) {
            this.$('.o_hr_attendance_message_message').append(_t("You have been Checked Out. Have a nice lunch!"));
        } else if (now.hours() < 17) {
            this.$('.o_hr_attendance_message_message').append(_t("You have been Checked Out. Have a good afternoon"));
        } else {
            this.$('.o_hr_attendance_message_message').append(_t("You have been Checked Out. Have a good evening"));
        }
    },
