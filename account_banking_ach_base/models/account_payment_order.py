...
class AccountPaymentOrder(models.Model):
    ...
    def generate_ach_file(self):
        ...
        if entries:
            entries.append({
                'type': self.get_transaction_type(amount=0),
                'routing_number': self.company_partner_bank_id.bank_id.routing_number,
                'account_number': self.company_partner_bank_id.acc_number,
                'amount': str(0),
                'name': self.company_partner_bank_id.partner_id.name,
                'addenda': [{
