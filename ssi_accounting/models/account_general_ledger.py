...
class SsiAccountGeneralLedger(models.AbstractModel):
...
#                     partner_name = line.partner_id.name
                    partner_name = line.partner_id.parent_id.name and str(line.partner_id.parent_id.name) + ', ' + line.partner_id.name or line.partner_id.name
